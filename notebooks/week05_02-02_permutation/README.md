NEUS 642 Week 6: Permutation statistics and digging deeper into functions.
...
* Error when you try to pull?  Might you have already edited one of the week 2 notebook files? If so you need to revert any changes:
  * `cd <my_NEUS_git_path>`
  * `cd notebooks/week05_02-02_permutation`
  * `git checkout -- *`
  * `git pull`
...
* Open [week05_permutation_stats_students.ipynb](week05_permutation_stats_students.ipynb) in Jupyter.
